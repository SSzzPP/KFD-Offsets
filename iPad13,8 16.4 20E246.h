...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.4.0: Mon Mar  6 20:40:42 PST 2023; root:xnu-8796.102.5~1/RELEASE_ARM64_T8103",
        ...
        .kernelcache__cdevsw = 0xfffffe000aacd208,
        .kernelcache__gPhysBase = 0xfffffe0007a7ffc0,
        .kernelcache__gPhysSize = 0xfffffe0007a7ffc0 + 8,
        .kernelcache__gVirtBase = 0xfffffe0007a7e198,
        .kernelcache__perfmon_devices = 0xfffffe000ab0b520,
        .kernelcache__perfmon_dev_open = 0xfffffe00080d03c0,
        .kernelcache__ptov_table = 0xfffffe00079cb188,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000ab0a990,
        .kernelcache__vm_pages = 0xfffffe00079c7eb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00079ca128,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000ab0a988,
        .kernelcache__vn_kqfilter = 0xfffffe000811f2b4,
    },
};
