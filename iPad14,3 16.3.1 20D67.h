...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.3.0: Wed Jan  4 21:23:25 PST 2023; root:xnu-8792.82.2~1/RELEASE_ARM64_T8112",
        ...
        .kernelcache__cdevsw = 0xfffffe000a99d190,
        .kernelcache__gPhysBase = 0xfffffe00079a81b0,
        .kernelcache__gPhysSize = 0xfffffe00079a81b0 + 8,
        .kernelcache__gVirtBase = 0xfffffe00079a6390,
        .kernelcache__perfmon_devices = 0xfffffe000a9d83b0,
        .kernelcache__perfmon_dev_open = 0xfffffe00080bcc60,
        .kernelcache__ptov_table = 0xfffffe00078f33b0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000a9d7800,
        .kernelcache__vm_pages = 0xfffffe00078f00d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00078f2370,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000a9d77f8,
        .kernelcache__vn_kqfilter = 0xfffffe000810cc88,
    },
};
