...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.3.0: Wed Jan  4 21:25:19 PST 2023; root:xnu-8792.82.2~1/RELEASE_ARM64_T8103",
        ...
        .kernelcache__cdevsw = 0xfffffe000aa01190,
        .kernelcache__gPhysBase = 0xfffffe00079a01b0,
        .kernelcache__gPhysSize = 0xfffffe00079a01b0 + 8,
        .kernelcache__gVirtBase = 0xfffffe000799e390,
        .kernelcache__perfmon_devices = 0xfffffe000aa3c3b0,
        .kernelcache__perfmon_dev_open = 0xfffffe00080b7cc4,
        .kernelcache__ptov_table = 0xfffffe00078eb3b8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000aa3b800,
        .kernelcache__vm_pages = 0xfffffe00078e80d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00078ea368,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000aa3b7f8,
        .kernelcache__vn_kqfilter = 0xfffffe000810a280,
    },
};
