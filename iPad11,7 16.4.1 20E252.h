...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a19d208,
        .kernelcache__gPhysBase = 0xfffffff0078c3fa0,
        .kernelcache__gPhysSize = 0xfffffff0078c3fa0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078c2178,
        .kernelcache__perfmon_devices = 0xfffffff00a1db500,
        .kernelcache__perfmon_dev_open = 0xfffffff007e55a88,
        .kernelcache__ptov_table = 0xfffffff007877160,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a1da990,
        .kernelcache__vm_pages = 0xfffffff007873ea8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007876110,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a1da988,
