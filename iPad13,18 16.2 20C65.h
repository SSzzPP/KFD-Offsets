...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3c5190,
        .kernelcache__gPhysBase = 0xfffffff0078400c8,
        .kernelcache__gPhysSize = 0xfffffff0078400c8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00783e2a8,
        .kernelcache__perfmon_devices = 0xfffffff00a4003b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef41c4,
        .kernelcache__ptov_table = 0xfffffff0077f3378,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3ff800,
        .kernelcache__vm_pages = 0xfffffff0077f0090,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077f2328,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3ff7f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f46780,
    },
};
