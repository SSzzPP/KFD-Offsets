...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3c9168,
        ...
        .kernelcache__perfmon_devices = 0xfffffff00a404330,
        .kernelcache__perfmon_dev_open = 0xfffffff007eef5d0,
        .kernelcache__ptov_table = 0xfffffff0077eb9c0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a403780,
        .kernelcache__vm_pages = 0xfffffff0077e86d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077ea970,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a403778,
