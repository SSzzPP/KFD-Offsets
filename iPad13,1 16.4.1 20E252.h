...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a481208,
        .kernelcache__gPhysBase = 0xfffffff007917fc0,
        .kernelcache__gPhysSize = 0xfffffff007917fc0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007916198,
        .kernelcache__perfmon_devices = 0xfffffff00a4bf520,
        .kernelcache__perfmon_dev_open = 0xfffffff007f0864c,
        .kernelcache__ptov_table = 0xfffffff0078cb188,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4be990,
        .kernelcache__vm_pages = 0xfffffff0078c7eb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078ca128,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4be988,
        .kernelcache__vn_kqfilter = 0xfffffff007f57538,
    },
};
