...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffe000a91d190,
        .kernelcache__gPhysBase = 0xfffffe00079840c8,
        .kernelcache__gPhysSize = 0xfffffe00079840c8 + 8,
        .kernelcache__gVirtBase = 0xfffffe00079822a8,
        .kernelcache__perfmon_devices = 0xfffffe000a9583b0,
        .kernelcache__perfmon_dev_open = 0xfffffe0008087f50,
        .kernelcache__ptov_table = 0xfffffe00078cf378,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000a957800,
        .kernelcache__vm_pages = 0xfffffe00078cc090,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00078ce328,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000a9577f8,
        .kernelcache__vn_kqfilter = 0xfffffe00080da50c,
    },
};
