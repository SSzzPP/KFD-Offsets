...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff0077ebc60,
        .kernelcache__gPhysSize = 0xfffffff0077ebc60 + 8,
        .kernelcache__gVirtBase = 0xfffffff0077e9e40,
        .kernelcache__perfmon_devices = 0xfffffff00a11c380,
        .kernelcache__perfmon_dev_open = 0xfffffff007e3b3ac,
        .kernelcache__ptov_table = 0xfffffff00779f248,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a11b800,
        .kernelcache__vm_pages = 0xfffffff00779c080,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00779e208,
