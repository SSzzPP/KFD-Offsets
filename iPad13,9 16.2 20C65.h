...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Mon Nov 28 20:09:33 PST 2022; root:xnu-8792.62.2~1/RELEASE_ARM64_T8103",
        ...
        .kernelcache__cdevsw = 0xfffffe000a9f5190,
        .kernelcache__gPhysBase = 0xfffffe00079a00c8,
        .kernelcache__gPhysSize = 0xfffffe00079a00c8 + 8,
        .kernelcache__gVirtBase = 0xfffffe000799e2a8,
        .kernelcache__perfmon_devices = 0xfffffe000aa303b0,
        .kernelcache__perfmon_dev_open = 0xfffffe00080b7f50,
        .kernelcache__ptov_table = 0xfffffe00078eb378,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000aa2f800,
        .kernelcache__vm_pages = 0xfffffe00078e8090,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00078ea328,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000aa2f7f8,
        .kernelcache__vn_kqfilter = 0xfffffe000810a50c,
    },
};
