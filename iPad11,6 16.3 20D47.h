...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a0e1178,
        .kernelcache__gPhysBase = 0xfffffff0077e7d48,
        .kernelcache__gPhysSize = 0xfffffff0077e7d48 + 8,
        .kernelcache__gVirtBase = 0xfffffff0077e5f28,
        .kernelcache__perfmon_devices = 0xfffffff00a11c380,
        .kernelcache__perfmon_dev_open = 0xfffffff007e37398,
        .kernelcache__ptov_table = 0xfffffff00779b288,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a11b800,
        .kernelcache__vm_pages = 0xfffffff0077980c0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00779a248,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a11b7f8,
        .kernelcache__vn_kqfilter = 0xfffffff007e89a20,
    },
};
