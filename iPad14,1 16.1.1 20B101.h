...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a671168,
        .kernelcache__gPhysBase = 0xfffffff0078afe40,
        .kernelcache__gPhysSize = 0xfffffff0078afe40 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078ae028,
        .kernelcache__perfmon_devices = 0xfffffff00a6ac330,
        .kernelcache__perfmon_dev_open = 0xfffffff007fa03b4,
        .kernelcache__ptov_table = 0xfffffff0078639b8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a6ab780,
        .kernelcache__vm_pages = 0xfffffff0078606e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007862978,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a6ab778,
        .kernelcache__vn_kqfilter = 0xfffffff007ff02cc,
    },
};
