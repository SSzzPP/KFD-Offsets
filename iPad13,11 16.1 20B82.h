...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffe000a9ed168,
        .kernelcache__gPhysBase = 0xfffffe000799be40,
        .kernelcache__gPhysSize = 0xfffffe000799be40 + 8,
        .kernelcache__gVirtBase = 0xfffffe000799a028,
        .kernelcache__perfmon_devices = 0xfffffe000aa28330,
        .kernelcache__perfmon_dev_open = 0xfffffe00080b3330,
        .kernelcache__ptov_table = 0xfffffe00078e79c0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000aa27780,
        .kernelcache__vm_pages = 0xfffffe00078e46d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00078e6970,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000aa27778,
        .kernelcache__vn_kqfilter = 0xfffffe00081057dc,
    },
};
