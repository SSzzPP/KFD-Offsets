...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff007998100,
        .kernelcache__gPhysSize = 0xfffffff007998100 + 8,
        .kernelcache__gVirtBase = 0xfffffff0079962d8,
        .kernelcache__perfmon_devices = 0xfffffff00a7ab520,
        .kernelcache__perfmon_dev_open = 0xfffffff007fc9480,
        ...
        .kernelcache__vn_kqfilter = 0xfffffff008015fe8,
    },
};
