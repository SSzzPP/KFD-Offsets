...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Thu Oct  6 19:34:00 PDT 2022; root:xnu-8792.42.7~1/RELEASE_ARM64_T8112",
        ...
        .kernelcache__cdevsw = 0xfffffe000a979168,
        .kernelcache__gPhysBase = 0xfffffe000799fe40,
        .kernelcache__gPhysSize = 0xfffffe000799fe40 + 8,
        .kernelcache__gVirtBase = 0xfffffe000799e028,
        .kernelcache__perfmon_devices = 0xfffffe000a9b4330,
        .kernelcache__perfmon_dev_open = 0xfffffe00080b01b0,
        .kernelcache__ptov_table = 0xfffffe00078eb9b8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000a9b3780,
        .kernelcache__vm_pages = 0xfffffe00078e86e0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00078ea978,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000a9b3778,
        .kernelcache__vn_kqfilter = 0xfffffe00081000c8,
    },
};
