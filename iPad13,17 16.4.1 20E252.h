...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffe000a9f1208,
        .kernelcache__gPhysBase = 0xfffffe0007a63fc0,
        .kernelcache__gPhysSize = 0xfffffe0007a63fc0 + 8,
        .kernelcache__gVirtBase = 0xfffffe0007a62198,
        .kernelcache__perfmon_devices = 0xfffffe000aa2f520,
        .kernelcache__perfmon_dev_open = 0xfffffe00080a43c0,
        .kernelcache__ptov_table = 0xfffffe00079af188,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000aa2e990,
        .kernelcache__vm_pages = 0xfffffe00079abeb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00079ae128,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000aa2e988,
        .kernelcache__vn_kqfilter = 0xfffffe00080f32b4,
    },
};
