...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a691190,
        .kernelcache__gPhysBase = 0xfffffff0078b81b0,
        .kernelcache__gPhysSize = 0xfffffff0078b81b0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078b6390,
        .kernelcache__perfmon_devices = 0xfffffff00a6cc3b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007fad05c,
        .kernelcache__ptov_table = 0xfffffff00786b3b0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a6cb800,
        .kernelcache__vm_pages = 0xfffffff0078680d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00786a370,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a6cb7f8,
        .kernelcache__vn_kqfilter = 0xfffffff007ffd074,
    },
};
