...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3cd190,
        .kernelcache__gPhysBase = 0xfffffff0078401b0,
        .kernelcache__gPhysSize = 0xfffffff0078401b0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00783e390,
        .kernelcache__perfmon_devices = 0xfffffff00a4083b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef40f4,
        .kernelcache__ptov_table = 0xfffffff0077f33b8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a407800,
        .kernelcache__vm_pages = 0xfffffff0077f00d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077f2368,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4077f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f466a0,
    },
};
