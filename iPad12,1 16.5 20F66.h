...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff007928010,
        .kernelcache__gPhysSize = 0xfffffff007928010 + 8,
        .kernelcache__gVirtBase = 0xfffffff0079261e8,
        .kernelcache__perfmon_devices = 0xfffffff00a3ab4f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ed75d0,
        ...
        .kernelcache__vn_kqfilter = 0xfffffff007f2641c,
    },
};
