...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffe0007a84100,
        .kernelcache__gPhysSize = 0xfffffe0007a84100 + 8,
        .kernelcache__gVirtBase = 0xfffffe0007a822d8,
        .kernelcache__perfmon_devices = 0xfffffe000ab13520,
        .kernelcache__perfmon_dev_open = 0xfffffe00080d45c0,
