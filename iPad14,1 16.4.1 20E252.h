...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a765208,
        .kernelcache__gPhysBase = 0xfffffff007997fc0,
        .kernelcache__gPhysSize = 0xfffffff007997fc0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007996198,
        .kernelcache__perfmon_devices = 0xfffffff00a7a3520,
        .kernelcache__perfmon_dev_open = 0xfffffff007fc9210,
        .kernelcache__ptov_table = 0xfffffff00794b180,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a7a2990,
        .kernelcache__vm_pages = 0xfffffff007947ec0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00794a130,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a7a2988,
        .kernelcache__vn_kqfilter = 0xfffffff008015ae0,
    },
};
