...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff0078f80e0,
        .kernelcache__gPhysSize = 0xfffffff0078f80e0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078f62b8,
        .kernelcache__perfmon_devices = 0xfffffff00a32f500,
        .kernelcache__perfmon_dev_open = 0xfffffff007ea9c8c,
