...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3bd168,
        .kernelcache__gPhysBase = 0xfffffff00783be40,
        .kernelcache__gPhysSize = 0xfffffff00783be40 + 8,
        .kernelcache__gVirtBase = 0xfffffff00783a028,
        .kernelcache__perfmon_devices = 0xfffffff00a3f8330,
        .kernelcache__perfmon_dev_open = 0xfffffff007eef5d0,
        .kernelcache__ptov_table = 0xfffffff0077ef9c0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3f7780,
        .kernelcache__vm_pages = 0xfffffff0077ec6d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077ee970,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3f7778,
        .kernelcache__vn_kqfilter = 0xfffffff007f41a7c,
    },
};
