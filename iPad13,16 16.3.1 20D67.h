...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffe000a925190,
        .kernelcache__gPhysBase = 0xfffffe00079841b0,
        .kernelcache__gPhysSize = 0xfffffe00079841b0 + 8,
        .kernelcache__gVirtBase = 0xfffffe0007982390,
        .kernelcache__perfmon_devices = 0xfffffe000a9603b0,
        .kernelcache__perfmon_dev_open = 0xfffffe0008087cc4,
        .kernelcache__ptov_table = 0xfffffe00078cf3b8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000a95f800,
        .kernelcache__vm_pages = 0xfffffe00078cc0d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00078ce368,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000a95f7f8,
        .kernelcache__vn_kqfilter = 0xfffffe00080da280,
    },
};
