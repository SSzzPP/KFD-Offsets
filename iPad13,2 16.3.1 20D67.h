...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3dd190,
        .kernelcache__gPhysBase = 0xfffffff00783c1b0,
        .kernelcache__gPhysSize = 0xfffffff00783c1b0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00783a390,
        .kernelcache__perfmon_devices = 0xfffffff00a4183b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef80f4,
        .kernelcache__ptov_table = 0xfffffff0077ef3b8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a417800,
        .kernelcache__vm_pages = 0xfffffff0077ec0d0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077ee368,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4177f8,
        .kernelcache__vn_kqfilter = 0xfffffff007f4a6a0,
    },
};
