...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3d1190,
        .kernelcache__gPhysBase = 0xfffffff00783c0c8,
        .kernelcache__gPhysSize = 0xfffffff00783c0c8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00783a2a8,
        .kernelcache__perfmon_devices = 0xfffffff00a40c3b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef41c4,
        .kernelcache__ptov_table = 0xfffffff0077ef378,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a40b800,
        .kernelcache__vm_pages = 0xfffffff0077ec090,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077ee328,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a40b7f8,
