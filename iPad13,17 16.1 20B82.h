...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.1.0: Thu Oct  6 19:33:23 PDT 2022; root:xnu-8792.42.7~1/RELEASE_ARM64_T8103",
        ...
        .kernelcache__cdevsw = 0xfffffe000a911168,
        .kernelcache__gPhysBase = 0xfffffe000797fe40,
        .kernelcache__gPhysSize = 0xfffffe000797fe40 + 8,
        .kernelcache__gVirtBase = 0xfffffe000797e028,
        .kernelcache__perfmon_devices = 0xfffffe000a94c330,
        .kernelcache__perfmon_dev_open = 0xfffffe0008083330,
        .kernelcache__ptov_table = 0xfffffe00078cb9c0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000a94b780,
        .kernelcache__vm_pages = 0xfffffe00078c86d8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00078ca970,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000a94b778,
        .kernelcache__vn_kqfilter = 0xfffffe00080d57dc,
    },
};
