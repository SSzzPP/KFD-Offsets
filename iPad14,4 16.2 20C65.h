...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.2.0: Mon Nov 28 20:10:34 PST 2022; root:xnu-8792.62.2~1/RELEASE_ARM64_T8112",
        ...
        .kernelcache__cdevsw = 0xfffffe000a989190,
        .kernelcache__gPhysBase = 0xfffffe00079a80c8,
        .kernelcache__gPhysSize = 0xfffffe00079a80c8 + 8,
        .kernelcache__gVirtBase = 0xfffffe00079a62a8,
        .kernelcache__perfmon_devices = 0xfffffe000a9c43b0,
        .kernelcache__perfmon_dev_open = 0xfffffe00080bcdd0,
        .kernelcache__ptov_table = 0xfffffe00078f3370,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000a9c3800,
        .kernelcache__vm_pages = 0xfffffe00078f0098,
