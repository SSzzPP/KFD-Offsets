...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a2a5178,
        .kernelcache__gPhysBase = 0xfffffff00784bc80,
        .kernelcache__gPhysSize = 0xfffffff00784bc80 + 8,
        .kernelcache__gVirtBase = 0xfffffff007849e60,
        .kernelcache__perfmon_devices = 0xfffffff00a2e0370,
        .kernelcache__perfmon_dev_open = 0xfffffff007ebcbe8,
        .kernelcache__ptov_table = 0xfffffff0077ff2a0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a2df800,
        .kernelcache__vm_pages = 0xfffffff0077fc0c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077fe250,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a2df7f8,
