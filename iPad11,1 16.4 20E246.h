...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a2e9208,
        .kernelcache__gPhysBase = 0xfffffff0078f3fa0,
        .kernelcache__gPhysSize = 0xfffffff0078f3fa0 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078f2178,
        .kernelcache__perfmon_devices = 0xfffffff00a327500,
        .kernelcache__perfmon_dev_open = 0xfffffff007ea5a88,
        .kernelcache__ptov_table = 0xfffffff0078a7160,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a326990,
        .kernelcache__vm_pages = 0xfffffff0078a3ea8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078a6110,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a326988,
        .kernelcache__vn_kqfilter = 0xfffffff007ef463c,
    },
};
