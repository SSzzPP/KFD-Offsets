...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a225178,
        .kernelcache__gPhysBase = 0xfffffff00781bc60,
        .kernelcache__gPhysSize = 0xfffffff00781bc60 + 8,
        .kernelcache__gVirtBase = 0xfffffff007819e40,
        .kernelcache__perfmon_devices = 0xfffffff00a260380,
        .kernelcache__perfmon_dev_open = 0xfffffff007e873ac,
        .kernelcache__ptov_table = 0xfffffff0077cf248,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a25f800,
        .kernelcache__vm_pages = 0xfffffff0077cc080,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0077ce208,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a25f7f8,
        .kernelcache__vn_kqfilter = 0xfffffff007ed9a44,
    },
};
