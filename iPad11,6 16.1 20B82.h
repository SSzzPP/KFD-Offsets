...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a0cd150,
        .kernelcache__gPhysBase = 0xfffffff0077e39d8,
        .kernelcache__gPhysSize = 0xfffffff0077e39d8 + 8,
        .kernelcache__gVirtBase = 0xfffffff0077e1bc0,
        .kernelcache__perfmon_devices = 0xfffffff00a108300,
        .kernelcache__perfmon_dev_open = 0xfffffff007e3279c,
        .kernelcache__ptov_table = 0xfffffff007797890,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a107780,
        .kernelcache__vm_pages = 0xfffffff0077946c8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007796850,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a107778,
