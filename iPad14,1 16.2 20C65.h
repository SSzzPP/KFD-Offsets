...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a685190,
        .kernelcache__gPhysBase = 0xfffffff0078b80c8,
        .kernelcache__gPhysSize = 0xfffffff0078b80c8 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078b62a8,
        .kernelcache__perfmon_devices = 0xfffffff00a6c03b0,
        .kernelcache__perfmon_dev_open = 0xfffffff007facfa8,
        .kernelcache__ptov_table = 0xfffffff00786b370,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a6bf800,
        .kernelcache__vm_pages = 0xfffffff007868098,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00786a330,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a6bf7f8,
        .kernelcache__vn_kqfilter = 0xfffffff007ffcfd0,
    },
};
